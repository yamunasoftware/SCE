...
The service is meant to be containerized and run on port 2016, on your compute instance. The container is compatible with every major container management platform; therefore, the deployment process should be very straightforward.